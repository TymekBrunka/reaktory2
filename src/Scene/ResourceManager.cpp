...
ResourceManager::ImportModel(const std::filesystem::path &filepath, bool allow_reload) {
...
Errors::Result<Renderer::Model *, int> ResourceManager::LoadModel(const char *name) {
...
Errors::Result<Renderer::Model *, int>
ResourceManager::ImportModel(const std::filesystem::path &filepath,
