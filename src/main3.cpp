...
int main(int argc, char *argv[]) {
  ...
  memcpy((void*)ctx.getRoot(), root, sizeof(Ogre::Root));
  ...
  // void **ctx_root = (void **)(&ctx.getRoot());
  // void **ctx_overlay_system = (void **)(&ctx.getOverlaySystem());
  //
  // *ctx_root = (void *)root;
  // *ctx_overlay_system = (void *)overlaySystem;
